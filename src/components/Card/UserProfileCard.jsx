...
const UserProfileCard = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const res = await axios.get('https://full-stack-ecom-my-sql-bd.vercel.app/api/user/profile');
        setUser(res.data);
      } catch (error) {
  ...
  const handleSave = async () => {
    try {
      await axios.put('https://full-stack-ecom-my-sql-bd.vercel.app/api/user/profile', user);
