...
//ตอนแรกเขียนแบบนี้ แต่เนื่องจากต้องการความรัดกุมในเรื่องPasswordจึงเปลี่ยนไปใช้Lib zxcvbn, zod
  ...
  //   // Send to backend
  //   try {
  //     const res = await axios.post('https://full-stack-ecom-my-sql-bd.vercel.app/api/register', form)
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await axios.post('https://full-stack-ecom-my-sql-bd.vercel.app/api/register', data)
